<template>
  ...
  <CurveArrow v-if="elmReady" :start-elm="tooltipElm!" :end-elm="anchorElm!" :options="curveOptions"></CurveArrow>
</template>
...
const curveOptions: PointOptions = {
  linear: true,
  startPlacement: 'top-right',
  endPlacement: 'right-mid',
  ctl1Offset: { x: 100, y: 100 }
}
onMounted(() => {
